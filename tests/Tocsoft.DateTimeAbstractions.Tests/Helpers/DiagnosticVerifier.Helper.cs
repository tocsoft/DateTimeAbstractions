...
namespace TestHelper
{
    ...
    public abstract partial class DiagnosticVerifier
    {
        ...
        private static readonly MetadataReference SystemRuntimeExtensionsReference = MetadataReference.CreateFromFile(typeof(System.Diagnostics.Stopwatch).Assembly.Location);
        private static readonly MetadataReference CSharpSymbolsReference = MetadataReference.CreateFromFile(typeof(CSharpCompilation).Assembly.Location);
        private static readonly MetadataReference CodeAnalysisReference = MetadataReference.CreateFromFile(typeof(Compilation).Assembly.Location);

        internal static string DefaultFilePathPrefix { get; set; } = "Test";

        internal static string CSharpDefaultFileExt { get; set; } = "cs";

        internal static string VisualBasicDefaultExt { get; set; } = "vb";

        internal static string TestProjectName { get; set; } = "TestProject";
        ...
        private Document[] GetDocuments(string[] sources, string language)
        {
            ...
            Project project = this.CreateProject(sources, language);
