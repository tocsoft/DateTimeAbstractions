...
namespace TestHelper
{
    ...
    public abstract partial class DiagnosticVerifier
    {
        ...
        /// </summary>
        /// <returns>The c# analyzer under test</returns>
        protected virtual DiagnosticAnalyzer GetCSharpDiagnosticAnalyzer()
        {
            return null;
        }

        protected IEnumerable<string> AdditionalCodeFiles { get; set; }

        /// <summary>
        /// Get the Visual Basic analyzer being tested (C#) - to be implemented in non-abstract class
        /// </summary>
        /// <returns>the visual basic analyzer undertest</returns>
        ...
        {
            Diagnostic[] diagnostics = this.GetSortedDiagnostics(sources, language, analyzer);
        ...
        private static void VerifyDiagnosticLocation(DiagnosticAnalyzer analyzer, Diagnostic diagnostic, Location actual, DiagnosticResultLocation expected)
        {
            ...
            Microsoft.CodeAnalysis.Text.LinePosition actualEndLinePosition = actualSpan.EndLinePosition;
            ...
            {
                int endColumn = expected.Column + expected.Length;
                if (actualEndLinePosition.Character + 1 != endColumn)
                {
                    Assert.True(
                        false,
                        $"Expected diagnostic to end at column \"{endColumn}\" was actually at column \"{actualEndLinePosition.Character + 1}\"\r\n\r\nDiagnostic:\r\n    {FormatDiagnostics(analyzer, diagnostic)}\r\n");
                }
            }
        }
        #endregion
